...
def GMM(data, test_data, test_data_true_class, k, dim):
    ...
    plt.scatter([x[0] for x in data_1_class1], [x[1] for x in data_1_class1], color="darkblue", label="class 0")
    plt.scatter([x[0] for x in data_1_class2], [x[1] for x in data_1_class2], color="royalblue", label="class 1")
    plt.legend()
